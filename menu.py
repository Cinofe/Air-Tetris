...
class Menu:
    def __init__(self):
        ...
        self.rect_UI = pg.Rect(self.__hw-115,self.__hh-300,415,224)
        self.rect_levelBox = pg.Rect((self.__hw-165,self.__hh-450,315,70))
        self.rect_playBox = pg.Rect((self.__hw-165,self.__hh-377,315,70))
        self.rect_quitBox = pg.Rect((self.__hw-165,self.__hh-304,315,70))
