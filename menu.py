...
class Menu:
    def __init__(self):
        ...
        self.rect_levelBox = pg.Rect((self.__hw-160,self.__hh-160,315,70))
        self.rect_playBox = pg.Rect((self.__hw-160,self.__hh-27,315,70))
        self.rect_quitBox = pg.Rect((self.__hw-160,self.__hh+115,315,70))
