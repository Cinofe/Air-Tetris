...
class Menu:
    def __init__(self):
        ...
        self.rect_UI = pg.Rect(65,210,415,224)
        self.rect_levelBox = pg.Rect((115,214,315,70))
        self.rect_playBox = pg.Rect((115,287,315,70))
        self.rect_quitBox = pg.Rect((115,360,315,70))
