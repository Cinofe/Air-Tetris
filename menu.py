...
class Menu:
    def __init__(self):
        ...
        self.rect_UI = pg.Rect(self.__hw-100,self.__hh-210,415,224)
        self.rect_levelBox = pg.Rect((self.__hw-150,self.__hh-214,315,70))
        self.rect_playBox = pg.Rect((self.__hw-150,self.__hh-287,315,70))
        self.rect_quitBox = pg.Rect((self.__hw-150,self.__hh-360,315,70))
