...
class Menu:
    def __init__(self):
        ...
        self.rect_levelBox = pg.Rect((self.__screenWidthHalf-240,self.__screenHeightHalf-120,315,70))
        self.rect_playBox = pg.Rect((self.__screenWidthHalf-240,self.__screenHeightHalf+13,315,70))
        self.rect_quitBox = pg.Rect((self.__screenWidthHalf-240,self.__screenHeightHalf+155,315,70))
