...
class Menu:
    def __init__(self):
        ...
        self.rect_typeBox = pg.Rect((self.__screenWidthHalf-240, self.__screenHeightHalf-170, 315, 70))
        self.rect_levelBox = pg.Rect((self.__screenWidthHalf-240,self.__screenHeightHalf-35, 315,70))
        self.rect_playBox = pg.Rect((self.__screenWidthHalf-240,self.__screenHeightHalf+95, 315,70))
        self.rect_quitBox = pg.Rect((self.__screenWidthHalf-240,self.__screenHeightHalf+230, 315,70))
